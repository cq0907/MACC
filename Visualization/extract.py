...
parser.add_argument('--method', default='base', type=str, metavar='m', help='method type: base or awg')
...
parser.add_argument('--p', default=3, type=int, help='performing label smooth or not')
...
if dataset == 'sysu':
    ...
    mask = query_label.expand(len(gall_label), len(query_label)).eq(gall_label.expand(len(query_label), len(gall_label)).t()).cuda()
