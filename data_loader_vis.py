...
class SYSUData(data.Dataset):
    ...
    def __getitem__(self, index):
        img1, label1 = self.train_color_image[self.aIndex[index]], self.train_color_label[self.aIndex[index]]
        img2, label2 = self.train_thermal_image[self.pIndex[index]], self.train_thermal_label[self.pIndex[index]]
        img3, label3 = self.train_thermal_image[self.nIndex[index]], self.train_thermal_label[self.nIndex[index]]
